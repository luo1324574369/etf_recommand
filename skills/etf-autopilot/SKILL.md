...
1. 阅读 `docs/adr/0008-codex-autonomous-optimization-objective.md` 和 `docs/plans/2026-08-22-codex-autopilot-implementation-plan.md`。
...
10. 只有通过全部硬门槛的候选才能发布；无候选通过时保持当前版本。
11. 发布前检查配置哈希去重和回滚锁；已回滚版本没有新证据不得重新发布。
12. 发布后创建版本分支、提交配置/证据/报告并推送远端；不得直接推送 `main`。
13. 最终输出报告路径、配置哈希、版本 ID、Git commit、OOS 指标、淘汰原因和回滚目标。
