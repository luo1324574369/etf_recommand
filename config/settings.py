...
PARAM_PRESETS = {
    "多因子轮动": [
    {"name": "🏆 收益优先型", "params": {"lookback_momentum": 20, "lookback_volatility": 60, "top_n": 3, "rebalance_freq": 20, "sector_penalty_factor": 0.5, "sector_exclude_threshold": -0.15, "max_monthly_turnover": 100.0, "drawdown_threshold": 0.0, "max_sector_exposure_pct": 50.0, "market_regime_switch": True, "enable_factor_monitor": False, "core_allocation_pct": 50.0, "regime_ma_period": 60, "regime_confirm_days": 3, "regime_vol_ratio_threshold": 1.2, "bull_momentum_mult": 1.3, "bear_value_mult": 1.2}},
    {"name": "⚖️ 均衡型", "params": {"lookback_momentum": 20, "lookback_volatility": 60, "top_n": 3, "rebalance_freq": 20, "sector_penalty_factor": 0.5, "sector_exclude_threshold": -0.15, "max_monthly_turnover": 100.0, "drawdown_threshold": 20.0, "max_sector_exposure_pct": 50.0, "market_regime_switch": True, "enable_factor_monitor": False, "core_allocation_pct": 50.0, "regime_ma_period": 60, "regime_confirm_days": 3, "regime_vol_ratio_threshold": 1.2, "bull_momentum_mult": 1.3, "bear_value_mult": 1.2}},
    {"name": "🛡️ 低回撤型", "params": {"lookback_momentum": 20, "lookback_volatility": 60, "top_n": 3, "rebalance_freq": 20, "sector_penalty_factor": 0.5, "sector_exclude_threshold": -0.15, "max_monthly_turnover": 60.0, "drawdown_threshold": 0.0, "max_sector_exposure_pct": 50.0, "market_regime_switch": False, "enable_factor_monitor": False, "core_allocation_pct": 50.0, "regime_ma_period": 60, "regime_confirm_days": 3, "regime_vol_ratio_threshold": 1.2, "bull_momentum_mult": 1.3, "bear_value_mult": 1.2}},
    {"name": "📊 低频交易型", "params": {"lookback_momentum": 20, "lookback_volatility": 60, "top_n": 3, "rebalance_freq": 20, "sector_penalty_factor": 0.5, "sector_exclude_threshold": -0.15, "max_monthly_turnover": 60.0, "drawdown_threshold": 0.0, "max_sector_exposure_pct": 80.0, "market_regime_switch": False, "enable_factor_monitor": False, "core_allocation_pct": 50.0, "regime_ma_period": 60, "regime_confirm_days": 3, "regime_vol_ratio_threshold": 1.2, "bull_momentum_mult": 1.3, "bear_value_mult": 1.2}},
],
}
