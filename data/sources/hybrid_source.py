...
ETF_INDEX_MAP = {
    ...
    "512400": "有色金属",  # 有色金属ETF
    # 新增宽基/行业
    "512040": "沪深300价值",  # 沪深300价值ETF
    "560050": "上证50",  # 上证50ETF华安
    "511030": "沪深300",  # 沪深300ETF华泰柏瑞
    "560880": "中证家电",  # 家电ETF龙头
    "515120": "创新药",  # 创新药ETF沪港深
    "159755": "中证电池",  # 电池ETF
    "159863": "光伏",  # 光伏ETF
    "512990": "中证保险",  # 保险主题ETF
    "159841": "银行",  # 银行ETF
...
ETF_CSINDEX_MAP = {
    ...
    # 新增宽基/行业
    "512040": "000914",  # 沪深300价值ETF → 沪深300价值
    "560050": "000016",  # 上证50ETF华安 → 上证50
    "511030": "000300",  # 沪深300ETF华泰柏瑞 → 沪深300
    "560880": "930697",  # 家电ETF龙头 → 中证家电
    "515120": "931142",  # 创新药ETF沪港深 → 中证创新药产业
    "159755": "931775",  # 电池ETF → 中证电池主题
    "159863": "399812",  # 光伏ETF → 中证光伏产业
    "512990": "930699",  # 保险主题ETF → 中证保险
    "159841": "399986",  # 银行ETF → 中证银行
    "512680": "399967",  # 军工ETF → 中证军工
    "159869": "931088",  # 游戏ETF → 中证游戏
    "516010": "931088",  # 游戏ETF → 中证游戏
    "512950": "000962",  # 央企改革ETF → 中证央企结构调整
...
ETF_TUSHARE_INDEX_MAP = {
    ...
    "159902": "399330.SZ",
    # 新增宽基
    "512040": "000914.SH",  # 沪深300价值
    "560050": "000016.SH",  # 上证50
    "511030": "000300.SH",  # 沪深300
}
...
class HybridDataSource:
    ...
    def _get_constituent_pe_history(self, csindex_code: str) -> list[dict]:
        """用中证指数官方成分股 + Tushare daily_basic pe_ttm 加权计算PE历史

        优化：仅取近3年交易日，每5天采样，平衡速度与精度。
        """
        ...
        try:
            ...
            cal = self._tushare.trade_cal(
                exchange='SSE',
                start_date=start_dt.strftime('%Y%m%d'),
                end_date=end_dt.strftime('%Y%m%d')
            )
            cal = cal[cal['is_open'] == 1]
            trade_dates = cal['cal_date'].tolist()[::5]  # 每5天采样一次
